    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main>
        <section className="mx-auto grid max-w-7xl gap-12 px-4 pb-16 pt-14 sm:px-6 lg:grid-cols-2 lg:gap-10 lg:px-8 lg:pt-20">
          <div>
            ...
            <h1 className="text-4xl font-bold leading-tight tracking-tight text-slate-900 sm:text-5xl xl:text-6xl">
              Build your startup with clarity, structure, and practical momentum.
            </h1>
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-3xl border border-white/60 bg-white/70 shadow-2xl shadow-blue-900/10 backdrop-blur-sm">
              <img
                ...
                alt="Founder planning business strategy"
        ...
        <section id="features" className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {features.map((feature) => (
              <article key={feature.title} className="flex h-full flex-col rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
        ...
        <section className="mx-auto max-w-5xl px-4 pb-20 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-gradient-to-r from-blue-600 to-emerald-500 px-6 py-14 text-center text-white shadow-2xl shadow-blue-500/20 sm:px-10">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Ready to build your business with clarity?</h2>
